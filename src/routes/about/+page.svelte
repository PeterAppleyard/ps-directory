<main class="min-h-screen bg-white">
	...
	<!-- Section 01 — The Company: editorial two-column -->
	<section class="border-b-2 border-stone-900 bg-white">
		<div class="mx-auto max-w-6xl divide-y-2 md:divide-y-0 md:grid md:grid-cols-[280px_1fr] md:divide-x-2 divide-stone-900">
			...
			<div class="px-8 py-12 md:py-16 space-y-5 text-stone-600 leading-relaxed text-[15px]">
				<p>
					Pettit &amp; Sevitt reshaped Sydney's suburban fringes between the 1950s and 1980s.
					At a time when project homes meant conservative brick veneers, they offered something
					radical — flat roofs, floor-to-ceiling glazing, and open-plan living at an accessible price.
				</p>
				<p>
					They were part of the <strong class="font-bold text-stone-900">Sydney School</strong>:
					a uniquely Australian modernism that responded to light, landscape, and climate rather
					than importing European ideas wholesale.
				</p>
				<p>
					Their advertising was as distinctive as the homes themselves. Shot by
					<strong class="font-bold text-stone-900">Max Dupain</strong>, the campaigns
					became classics of Australian graphic design — stark black and white photographs,
					bold type, and an unapologetic confidence in modernist ideals.
				</p>
			</div>
		</div>
	</section>

	<!-- Section 02 — The Styles: three inverted panels -->
	<section class="border-b-2 border-stone-900 bg-white">
		<div class="mx-auto max-w-6xl">
			<!-- Label row -->
			...
			<div class="grid grid-cols-1 divide-y-2 md:divide-y-0 md:grid-cols-3 md:divide-x-2 divide-stone-900">
				<div class="group px-8 py-12 transition-colors duration-200 hover:bg-stone-900">
					...
					<p class="text-sm leading-relaxed text-stone-500 transition-colors group-hover:text-stone-400">
						Low-pitched roof, strong horizontal emphasis, deep connection to the ground plane.
						The most iconic P&amp;S silhouette — hugging the landscape rather than competing with it.
					</p>
				</div>
				...
				<div class="group px-8 py-12 transition-colors duration-200 hover:bg-stone-900">
					...
					<p class="text-sm leading-relaxed text-stone-500 transition-colors group-hover:text-stone-400">
						A response to sloping terrain rather than a fight against it. Dramatic interior
						volumes and staggered floors — spatial drama that flat sites simply couldn't offer.
					</p>
				</div>
			</div>
		</div>
